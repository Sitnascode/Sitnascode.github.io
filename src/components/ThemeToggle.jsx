...
const ThemeToggle = ({ className = '' }) => {
  ...
  return (
    <button
      onClick={() => {
        console.log('ThemeToggle button clicked, current isDark:', isDark);
        toggleTheme();
      }}
      className={`p-2 sm:p-3 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors ${className} touch-manipulation`}
